...
export function IconTruck() {
  return (
    <svg className={iconClass} fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 17h8M3 9h11v8H3V9zm11 0h4l3 4v4h-7V9zM7 17a2 2 0 100-4 2 2 0 000 4zm10 0a2 2 0 100-4 2 2 0 000 4z" />
    </svg>
  );
}
...
export function IconWrench() {
  return (
    <svg className={iconClass} fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M11 4a2 2 0 114 0v1.5a6.5 6.5 0 013.5 11.5H7a6.5 6.5 0 013.5-11.5V4z" />
    </svg>
  );
}
...
export function IconCheck({ className = "text-brand-600" }: { className?: string }) {
  return (
    <svg className={`h-5 w-5 shrink-0 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden>
...
export function ServiceIcon({ name }: { name: keyof typeof SERVICE_ICONS }) {
